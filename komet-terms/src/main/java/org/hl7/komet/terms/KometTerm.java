...
public class KometTerm {
    ...
    public static final ConceptProxy MODULE_PREFERENCE_ORDER_FOR_STAMP_COORDINATE =
            ConceptProxy.make("Module preference order for stamp coordinate (SOLOR)", UUID.fromString("ddeda759-e89c-5186-aa40-d63070756ab4"));
    ...
    public static final ConceptProxy POSITION_ON_PATH =
            ConceptProxy.make("Position on path (SOLOR)", UUID.fromString("31173582-a49d-51c6-813f-f42d0976aaea"));
    ...
    public static final ConceptProxy PATH_FOR_PATH_COORDINATE =
            ConceptProxy.make("Path for path coordinate (SOLOR)", UUID.fromString("748e073c-fea7-58dd-8aa3-f18fdd82ddfc"));
    ...
    public static final ConceptProxy ALLOWED_STATES_FOR_STAMP_COORDINATE =
            ConceptProxy.make("Allowed states for stamp coordinate (SOLOR)", java.util.UUID.fromString("23f69f6f-a502-5876-a835-2b1b4d5ce91e"));
    ...
    public static final ConceptProxy MODULE_EXCLUSION_SET_FOR_STAMP_COORDINATE =
            ConceptProxy.make("Module exclusion set for stamp coordinate (SOLOR)", java.util.UUID.fromString("3fe047f0-33b0-5254-91c2-43e65f90d30b"));
    ...
    public static final ConceptProxy MODULES_FOR_STAMP_COORDINATE =
            ConceptProxy.make("Modules for stamp coordinate (SOLOR)", UUID.fromString("bf69c4f1-95c9-5956-a10a-d3ba9276c019"));
    ...
    public static final ConceptProxy NAVIGATION_CONCEPT_SET =
            ConceptProxy.make("Navigation concept set (SOLOR)", UUID.fromString("fc965c5d-ad17-555e-bcb5-b78fd45c8c5f"));
    ...
    public static final ConceptProxy CLASSIFIER_FOR_LOGIC_COORDINATE =
            ConceptProxy.make("Classifier for logic coordinate (SOLOR)", UUID.fromString("4b90e89d-2a0e-5ca3-8ae5-7498d148a9d2"));
    ...
    public static final ConceptProxy DESCRIPTION_LOGIC_PROFILE_FOR_LOGIC_COORDINATE =
            ConceptProxy.make("Description logic profile for logic coordinate (SOLOR)", UUID.fromString("aef80e34-b2dd-5dca-a989-3e0ee2699be3"));
    ...
    public static final ConceptProxy INFERRED_ASSEMBLAGE_FOR_LOGIC_COORDINATE =
            ConceptProxy.make("Inferred assemblage for logic coordinate (SOLOR)", UUID.fromString("9ecf4d76-4346-5e5d-8316-bdff48a5c154"));
    ...
    public static final ConceptProxy STATED_ASSEMBLAGE_FOR_LOGIC_COORDINATE =
            ConceptProxy.make("Stated assemblage for logic coordinate (SOLOR)", UUID.fromString("cfd2a47e-8169-5e71-9122-d5b73efd990a"));
    ...
    public static final ConceptProxy DIGRAPH_FOR_LOGIC_COORDINATE =
            ConceptProxy.make("Digraph for logic coordinate (SOLOR)", UUID.fromString("1cdacc80-0dea-580f-a77b-8a6b273eb673"));
    ...
    public static final ConceptProxy ROOT_FOR_LOGIC_COORDINATE =
            ConceptProxy.make("Root for logic coordinate (SOLOR)", UUID.fromString("862cc189-bbcb-51a0-89a4-16e1854be247"));
    ...
    public static final ConceptProxy LANGUAGE_SPECIFICATION_FOR_LANGUAGE_COORDINATE =
            ConceptProxy.make("Language specification for language coordinate (SOLOR)", UUID.fromString("b0ad4d77-e1bc-5fd1-922e-5fad675e9bfd"));
    ...
    public static final ConceptProxy DIALECT_ASSEMBLAGE_PREFERENCE_LIST_FOR_LANGUAGE_COORDINATE =
            ConceptProxy.make("Dialect assemblage preference list for language coordinate (SOLOR)", UUID.fromString("c060ffbf-e95f-5960-b296-8a3255c820ac"));
    ...
    public static final ConceptProxy DESCRIPTION_TYPE_PREFERENCE_LIST_FOR_LANGUAGE_COORDINATE =
            ConceptProxy.make("Description type preference list for language coordinate (SOLOR)", UUID.fromString("44c7eab6-fdb8-5427-9d7a-52ab63f7a6f9"));
    ...
    public static final ConceptProxy MODULE_PREFERENCE_LIST_FOR_LANGUAGE_COORDINATE =
            ConceptProxy.make("Module preference list for language coordinate (SOLOR)", UUID.fromString("f36e7ca6-34a2-58b5-8b25-736457515f9c"));
    ...
    public static final ConceptProxy VERTEX_STATE_SET =
            ConceptProxy.make("Vertex state set (SOLOR)", UUID.fromString("347cd3f2-8130-5032-8960-091e194e9afe"));
    ...
    public static final ConceptProxy VERTEX_SORT =
            ConceptProxy.make("Vertex sort (SOLOR)", UUID.fromString("e973f077-a99d-59e6-b7bd-804e87e0e639"));
    ...
    public static final ConceptProxy CURRENT_ACTIVITY =
            ConceptProxy.make("Current activity (SOLOR)", UUID.fromString("926f691f-3418-565c-900e-322ba797888e"));
    ...
    public static final ConceptProxy PATH_ORIGINS_FOR_STAMP_PATH =
            ConceptProxy.make("Path origins for stamp path (SOLOR)", UUID.fromString("f33e1668-34dd-53dd-8728-31b29934b482"));
